                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="serch-tab-pane" role="tabpanel" aria-labelledby="disabled-tab" tabindex="0">
                                ...
                                <form action="search.php" method="post">
                                    <input type="text" name="search" class="form-control" id="exampleFormControlInput1" placeholder="first Name, last Name, phone Number" required>
                                    <br>
                                    <button style="width:100px" class="btn btn-outline-primary">search</button>
                                </form>
                            </div>
                        </div>
                    </div>
